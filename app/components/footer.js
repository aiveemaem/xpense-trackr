      ...
      <div className="container mx-auto flex flex-wrap items-center justify-between">
        ...
        <nav className="flex space-x-0 md:space-x-2 lg:space-x-4">
          <Link
            ...
            aria-label="Go to developer's GitHub"
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 496 512"
              className="fill-current h-6 w-6 md:h-8 md:w-8"
            >
          ...
          <Link
            href="https://www.linkedin.com/in/aivee-mae-madrelejos-77649518a/"
            className="btn btn-square btn-ghost"
            aria-label="Go to developer's LinkedIn"
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 448 512"
